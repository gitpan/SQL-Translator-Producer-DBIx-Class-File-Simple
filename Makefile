# This Makefile is for the SQL::Translator::Producer::DBIx::Class::File::Simple extension to perl.
#
...
#     NAME => q[SQL::Translator::Producer::DBIx::Class::File::Simple]
#     VERSION_FROM => q[lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm]
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = SQL::Translator::Producer::DBIx::Class::File::Simple
NAME_SYM = SQL_Translator_Producer_DBIx_Class_File_Simple
VERSION = 0.2
...
FULLEXT = SQL/Translator/Producer/DBIx/Class/File/Simple
BASEEXT = Simple
PARENT_NAME = SQL::Translator::Producer::DBIx::Class::File
DLBASE = $(BASEEXT)
VERSION_FROM = lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/SQL/Translator/Producer/DBIx/Class/File
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/SQL/Translator/Producer/DBIx/Class/File
...
TO_INST_PM = lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm

PM_TO_BLIB = lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm \
	blib/lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm
...
DISTNAME = SQL-Translator-Producer-DBIx-Class-File-Simple
DISTVNAME = SQL-Translator-Producer-DBIx-Class-File-Simple-0.2
...
manifypods : pure_all  \
	lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm \
	lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm $(INST_MAN3DIR)/SQL::Translator::Producer::DBIx::Class::File::Simple.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         SQL-Translator-Producer-DBIx-Class-File-Simple' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.2' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm blib/lib/SQL/Translator/Producer/DBIx/Class/File/Simple.pm 
	$(NOECHO) $(TOUCH) $@
